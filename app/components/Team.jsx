      ...
      <div className="flex flex-col items-center gap-22">
        ...
        <div className="flex flex-col  md:flex-row md:mr-56 items-center gap-8 max-w-7xl">
          ...
          <div className="text-left md:text-left">
            <h2 className="md:text-6xl text-2xl font-bold">Mr. Panneer Selvam D</h2>
        ...
        {/* Member 2 */}
      <div className="flex flex-col mt-4 md:flex-row-reverse items-center md:ml-64 gap-8 max-w-7xl">
          ...
          <div className="text-right md:text-right">
            <h2 className="md:text-6xl text-3xl font-bold"> Mr. J Praveen</h2>
